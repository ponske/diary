    ...
    (rawItems || []).map((it) => {
      ...
      if (it.type === 'reservation') {
        return {
          uid: makeUid(),
          type: 'reservation',
          reservationName: it.reservationName || '予約レストラン',
    ...
    if (format === 'detailed') {
      ...
      for (const it of items) {
        ...
        if (it.type === 'reservation') {
          ...
          text += `🍽️ ${it.reservationName || '予約レストラン'}${area}\n`;
      ...
      <ViewShot ref={mapShotRef} style={styles.mapFrameWrap} options={{ format: 'jpg', quality: 0.95 }}>
        <View style={styles.mapFrame}>
          ...
          <View style={styles.mapContainer}>
            <MapView ref={mapRef} style={styles.map} initialRegion={mapRegion} showsUserLocation={false}>
              <Marker
                ...
                return (
                  <ScaleDecorator>
                    <TouchableOpacity
                      ...
                      activeOpacity={0.9}
                    >
                      <View style={[styles.routeItem, { borderLeftColor: '#111827', opacity: isActive ? 0.85 : 1 }]}>
                  ...
                  <ScaleDecorator>
                    ...
                    >
                      <View style={[styles.routeItem, { borderLeftColor: '#111827', opacity: isActive ? 0.85 : 1 }]}>
                        ...
                        <Text style={styles.attractionName} numberOfLines={1} ellipsizeMode="tail">
                            🍽️ {it.reservationName || '予約レストラン'} {area}
                          </Text>
                          <TouchableOpacity onPress={() => removeItemByUid(it.uid)} style={styles.smallAction}>
                            <Text style={styles.smallActionText}>✕</Text>
                          </TouchableOpacity>
                  ...
                  >
                    <View
                      style={[
                        ...
                        { borderLeftColor: getPriorityColor(it.priority), opacity: isActive ? 0.85 : 1 },
                      ]}
                    >
                      <View style={styles.routeItemHeader}>
                        <View style={styles.orderBadgeWrap}>
